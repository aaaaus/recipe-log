const recipes = [
  {
    name: "One Pot Bacon Broccoli Mac and Cheese",
    ingredients: [
      {name: 'pasta', amount: '1/2 lb'},
      {name: 'bacon', amount: '4 oz'},
      {name: 'broccoli', amount: '1/2 lb'},
      {name: 'medium cheddar cheese', amount: '8 oz'},
      {name: 'evaporated milk', amount: '1 cup'},
      {name: 'Dijon mustard', amount: '1/2 tsp'},
      {name: 'smoked paprika', amount: '1/2 tsp'},
      {name: 'hot sauce', amount: '1/2 tsp'},
